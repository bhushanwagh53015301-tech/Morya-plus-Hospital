import diagnosticImage from "@/assets/images/facility-diagnostic.jpg";
import emergencyImage from "@/assets/images/hero-emergency.jpg";
import womenChildImage from "@/assets/images/gallery-1.jpg";

export const blogPosts = [
  {
    slug: "emergency-care-kunjirwadi-pune",
    category: "Emergency Care",
    readTime: "5 min read",
    image: emergencyImage,
    imageAlt: "Emergency care support at Morya Plus Hospital",
    imageClassName: "object-center",
    title: "When to Choose an Emergency Hospital in Kunjirwadi, Pune",
    excerpt:
  ...
  {
    slug: "preventive-health-checkups-pune",
    category: "Preventive Health",
    readTime: "4 min read",
    image: diagnosticImage,
    imageAlt: "Diagnostic and preventive health checkup services",
    imageClassName: "object-center",
    title: "Why Regular Health Checkups Matter for Families in Pune",
    excerpt:
  ...
  {
    slug: "womens-child-healthcare-kunjirwadi",
    category: "Women & Child Care",
    readTime: "5 min read",
    image: womenChildImage,
    imageAlt: "Women and child healthcare consultation support",
    imageClassName: "object-top",
    title: "Trusted Women and Child Healthcare in Kunjirwadi",
    excerpt:
